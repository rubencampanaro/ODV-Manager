...
require_once "./functions_resoconto_giornaliero_amministrazione.php";
?>
...
<head>
  ...
  function opzioneAzione(element, opzione, dati) {
    ...
    httpRequest.open("POST", "./app.php?n=functions_resoconto_giornaliero_amministrazione.php", true);
...
<body>
  ...
  <div class="py-5 text-center bg-yellow">
    <div class="d-flex align-items-center justify-content-center">
      ...
      <h1 class="text-white fw-bold text-shadow">Resoconto giornaliero - Amministrazione</h1>
    </div>
  </div>
