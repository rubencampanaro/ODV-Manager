...
function compilaVolontari() {
  $query = "SELECT codice, CONCAT(nome, ' ', cognome), codice_fiscale FROM volontari;";
...
<head>
  ...
  function gestioneBenemerenze(element, opzione, dati) {
    ...
    httpRequest.open("POST", "./app.php?n=functions_benemerenze_volontari.php", true);
...
<body>
  ...
  <div class="py-5 text-center bg-success">
    <div class="d-flex align-items-center justify-content-center">
      ...
      <h1 class="text-white fw-bold text-shadow">Gestione benemerenze - Volontari</h1>
    </div>
  </div>
  <div class="container my-4 p-4 bg-white rounded shadow">
    <label class="fw-bold">Volontario</label>
    <select id="volontario" class="form-select" required onchange="gestioneBenemerenze(this, 'visualizza', this.value)">
      <option disabled selected value>Seleziona...</option>
      <?php echo compilaVolontari(); ?>
    </select>
